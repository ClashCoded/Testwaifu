...
Own Waifustation NFTs to earn ETH.
      ...
      {!showTimer ? (
        ...
        <h2 className="minting-title">社区预售</h2>
        <div
      ...
      >
        ...
        <h3 className="minting-subtitle">其余Waifus</h3>
        <ProgressBar
...
export default connect(mapStateToProps, { nftValues })(HeroConnectedCN)
